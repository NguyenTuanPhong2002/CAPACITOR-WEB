$(document).ready(function () {
    ...
    var dbRef = firebase.database().ref('halo')
    ...
    postListRef.on('value', function (snapshot) {
        ...
        snapshot.forEach(function (keysSnapshot) {
            ...
            const cosFi = keysSnapshot.child('CosF').val()
            const time = keysSnapshot.child('TIME').val()

            const coil_1 = keysSnapshot.child('Co1').val()
            const coil_2 = keysSnapshot.child('Co2').val()
            const coil_3 = keysSnapshot.child('Co3').val()
            const coil_4 = keysSnapshot.child('Co4').val()

            const contactor_1 = keysSnapshot.child('Co1').val()
            const contactor_2 = keysSnapshot.child('Co2').val()
            const contactor_3 = keysSnapshot.child('Co3').val()
            const contactor_4 = keysSnapshot.child('Co4').val()
